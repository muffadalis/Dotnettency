...
namespace MvcWeb
{
    ...
    {
        public static async Task RunAsync(IApi api, Tenant tenant)
        {
            if ((await api.Pages.GetStartpageAsync()) == null)
            {
                ...
                startpage.Title = tenant.Name + " - Piranha CMS - Open Source, Cross Platform Asp.NET Core CMS";
                ...
                // Start page hero
                startpage.Hero.Subtitle = "By " + tenant.Name + " - for developers";
